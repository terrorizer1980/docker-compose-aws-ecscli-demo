...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-init-efs.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-init-efs.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-yum.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-yum.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-init-postgres.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-init-postgres.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-init-container.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-init-container.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-stream-producer-1.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-stream-producer-2.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-redoer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-redoer.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-apiserver.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-apiserver.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-webapp.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-webapp.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-xterm.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-xterm.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-phppgadmin.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-phppgadmin.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-10M/ecs-params-jupyter.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-10M/docker-compose-jupyter.yaml \
