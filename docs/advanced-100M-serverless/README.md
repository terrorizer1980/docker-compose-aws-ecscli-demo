...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-init-efs.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-init-efs.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-yum.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-yum.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-init-postgres.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-init-postgres.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-init-container.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-init-container.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-stream-producer-1.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-stream-producer-2.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-stream-producer-3.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-stream-producer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-stream-producer-4.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-sshd.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-sshd.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-stream-loader.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-stream-loader.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-redoer.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-redoer.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-apiserver.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-apiserver.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-webapp.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-webapp.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-xterm.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-xterm.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-phppgadmin.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-phppgadmin.yaml \
...
1. Run
   ...
   Example:
    ...
    ecs-cli compose \
      --cluster-config ${SENZING_AWS_ECS_CLUSTER_CONFIG} \
      --ecs-params ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/ecs-params-jupyter.yaml \
      --file ${GIT_REPOSITORY_DIR}/resources/advanced-100M-serverless/docker-compose-jupyter.yaml \
